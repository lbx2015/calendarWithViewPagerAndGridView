...
import com.necer.ncalendar.calendar.NMonthGridCalendar;
...
public class TestActivity extends Activity {
    private NMonthGridCalendar nmonthcalendar;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        nmonthcalendar = (NMonthGridCalendar) findViewById(R.id.nmonthcalendar);
