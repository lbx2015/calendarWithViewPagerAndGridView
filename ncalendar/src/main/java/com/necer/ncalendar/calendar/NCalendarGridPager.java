...
public abstract class NCalendarGridPager extends ViewPager {

    protected NCalendarGridAdapter calendarAdapter;
    ...
    public NCalendarGridPager(Context context) {
        this(context, null);
    }

    public NCalendarGridPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected abstract NCalendarGridAdapter getCalendarAdapter();
    ...
    public void setPointList(List<String> pointList) {
        ...
        NCalendarGridView nCalendarView = calendarAdapter.getCalendarViews().get(getCurrentItem());
