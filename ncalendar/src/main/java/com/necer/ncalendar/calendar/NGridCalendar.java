...
public class NGridCalendar extends FrameLayout implements NestedScrollingParent, ValueAnimator.AnimatorUpdateListener, OnWeekCalendarChangedListener, OnMonthCalendarChangedListener {

    private NWeekCalendar weekCalendar;
    private NMonthGridCalendar monthCalendar;
    ...
    public NGridCalendar(Context context) {
        this(context, null);
    }

    public NGridCalendar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NGridCalendar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        monthCalendar = new NMonthGridCalendar(context, attrs);
    ...
    private int getMonthCalendarOffset() {
        NMonthGridView currectMonthView = monthCalendar.getCurrectMonthView();
        //该月有几行
