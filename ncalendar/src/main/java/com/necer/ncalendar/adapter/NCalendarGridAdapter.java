...
public abstract class NCalendarGridAdapter extends PagerAdapter {


    protected Context mContext;
    protected int mCount;//总页数
    protected int mCurr;//当前位置
    protected SparseArray<NCalendarGridView> mCalendarViews;
    protected DateTime mDateTime;

    public NCalendarGridAdapter(Context mContext, int count, int curr, DateTime dateTime) {
    ...
    public SparseArray<NCalendarGridView> getCalendarViews() {
